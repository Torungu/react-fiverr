            ...
            <div className="w-1/2">
              ...
              <form className="space-y-3" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <button
                    type="submit"
                    className="py-2 px-5 rounded-md bg-black hover:bg-[#404145] my-5 hover:text-white text-white w-full"
                  >
                    Continue
                  </button>
                </div>
        ...
        return (
          <div>
            <form onSubmit={handleUploadAvatar}>
              ...
              <button type="submit" className="py-5 px-2 bg-black text-white">
                upload hinh
              </button>
            </form>
          </div>
